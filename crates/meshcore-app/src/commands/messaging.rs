...
pub fn delete_conversation(
    ...
    state
        .db
        .with_conn(|conn| meshcore_storage::messages::delete_conversation(conn, &contact_pubkey))
...
pub fn search_messages(
    ...
    state
        .db
        .with_conn(|conn| meshcore_storage::messages::search_messages(conn, &query, limit))
        .map_err(|e| e.to_string())
}
